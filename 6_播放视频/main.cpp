...
int showType = 1;  //显示的模式
int sourceType = 0; //源文件模式
char *fileName = "../assert/1.avi";
...
int main (int argc, char **argv)
{
    ...
    if (argc >= 2)
    {
        ...
        {
            fileName = argv[3];
            cout << argv[0] << "showType:" << showType <<
                    " sourceType:" << sourceType << "fileName:" << fileName << endl;
        }
        else
        {
            cout << argv[0] << "showType:" << showType << " sourceType:" << sourceType << endl;
        }
    }
