...
#define MINAME "开运算/闭运算OpenClose"

MIOpenClose::MIOpenClose()
{
    ...
    button->setText("...");
    connect(button, &QPushButton::clicked, this, &MIOpenClose::selectFile);
    ...
    connect(horizontalSlider, &QSlider::valueChanged, this, &MIOpenClose::onSubmitClicked);
...
void MIOpenClose::onSubmitClicked()
{
    QImage qimage;
