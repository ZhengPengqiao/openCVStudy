...
#define MINAME "双边滤波BilateralFilter"

MIBilateralFilter::MIBilateralFilter()
{
    ...
    button->setText("...");
    connect(button, &QPushButton::clicked, this, &MIBilateralFilter::selectFile);
    ...
    connect(horizontalSlider, &QSlider::valueChanged, this, &MIBilateralFilter::onSubmitClicked);
...
void MIBilateralFilter::selectFile()
{
...
void MIBilateralFilter::onSubmitClicked()
{
    QImage qimage;
    ...
    //进行方框滤波操作
    Mat out;
    bilateralFilter ( image, out, horizontalSlider->value()+1,
                      (horizontalSlider->value()+1)*2, (horizontalSlider->value()+1)/2 );
    //创建窗口
