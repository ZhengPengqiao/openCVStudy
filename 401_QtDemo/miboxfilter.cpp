...
#define MINAME "方框滤波BoxFilter"

MIBoxFilter::MIBoxFilter()
{
    ...
    button->setText("...");
    connect(button, &QPushButton::clicked, this, &MIBoxFilter::selectFile);
    ...
    scrollAreaWidgetContents->resize(1000,1000);
...
void MIBoxFilter::onSubmitClicked()
{
    QImage qimage;
