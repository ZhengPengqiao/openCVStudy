...
MIErode::MIErode()
{
    ...
    button->setText("...");
    connect(button, &QPushButton::clicked, this, &MIErode::selectFile);
    ...
    connect(horizontalSlider, &QSlider::valueChanged, this, &MIErode::onSubmitClicked);
