...
#define MINAME "膨胀/腐蚀ErodeDilate"

MIErodeDilate::MIErodeDilate()
{
    ...
    button->setText("...");
    connect(button, &QPushButton::clicked, this, &MIErodeDilate::selectFile);
    ...
    connect(horizontalSlider, &QSlider::valueChanged, this, &MIErodeDilate::onSubmitClicked);
...
void MIErodeDilate::onSubmitClicked()
{
    QImage qimage;
